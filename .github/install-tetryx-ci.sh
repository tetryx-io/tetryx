...
nix-env --substituters "https://store.tetryx.io/tetryx-ci https://cache.nixos.org" --trusted-public-keys "tetryx-ci:U5Sey4mUxwBXM3iFapmP0/ogODXywKLRNgRPQpEXxbo= cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY=" -if "$expr"
