...
import { RiEditLine, RiPlayLargeFill, RiSave2Fill } from "react-icons/ri";
...
const AgentRender = ({
  ...
  return (
    <div className="search-results mb-5 mt-10 mx-4 md:mx-10 pb-[160px] dark:bg-neutral-900 dark:text-white">
        {loading ? (<Skeleton count={10} baseColor="#202020" highlightColor="#444" />) :
        (<div>
            <div className="flex w-[100%] mb-4 justify-between items-center">
                ...
                <div className="flex space-x-2">
                    ...
                    <DefaultButton
                        ...
                        iconRight={isEditing ? <RiSave2Fill size={15} /> : <RiEditLine size={15} />}
                        variant="default"
                        size="medium"
            ...
            >
                ...
                >
                <Editor
                    className={"leading-[25.6px] list-decimal text-neutral-600 dark:text-neutral-300 font-medium"}
                    readOnly={!isEditing}
                    autoFocus={isEditing}
